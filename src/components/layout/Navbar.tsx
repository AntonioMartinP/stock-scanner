      ...
      >
        ...
        <div className="flex flex-col px-4 py-3 gap-1">
          <Link
            href="/"
            onClick={closeMenu}
            className={`flex items-center rounded-lg px-4 py-4 text-lg font-medium transition
        ...
        {(!loading && user) || (!loading && !user) ? (
          <div className="border-t border-gray-100 px-4 py-4 flex flex-col gap-3 mt-auto">
            {!loading && user && (
              <>
                <div className="flex items-center gap-3 rounded-lg bg-gray-50 px-4 py-3">
                  <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full
                                  bg-blue-100 text-base font-semibold text-blue-700">
                    {user.email?.[0].toUpperCase()}
                  </div>
                  <span className="text-base text-gray-600 truncate">{user.email}</span>
                </div>
                <button
                  onClick={handleLogout}
                  className="flex w-full items-center justify-center gap-2 rounded-lg
                             bg-red-500 px-4 py-4 text-lg font-semibold text-white
              ...
              <div className="flex flex-col gap-3">
                <Link
                  ...
                  className="flex w-full items-center justify-center rounded-lg border
                             border-gray-200 px-4 py-4 text-lg font-medium text-gray-700
                ...
                <Link
                  ...
                  className="flex w-full items-center justify-center rounded-lg bg-blue-600
                             px-4 py-4 text-lg font-semibold text-white transition hover:bg-blue-700"
                >
                  {t('register')}
                </Link>
              </div>
