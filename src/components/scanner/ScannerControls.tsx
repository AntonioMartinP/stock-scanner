...
export default function ScannerControls({
  ...
  const selectCls = `h-9 w-full rounded-lg border border-gray-300 bg-white px-3 pr-8 text-sm
  ...
  return (
    <div className="flex flex-col md:flex-row md:flex-wrap md:items-end gap-4">
      ...
      <button
        ...
        className="flex w-full md:w-auto h-9 items-center justify-center gap-2 rounded-lg
                   bg-blue-600 px-4 text-sm font-semibold text-white shadow-sm
      ...
      >
        ...
        <span className="hidden md:inline">{t("controls.refresh")}</span>
      </button>
